...
CREATE TABLE `sis_user_student` (
  ...
  KEY `FK_user_student_user_idx` (`user_id`),
  KEY `FK_user_student_student` (`student_id`),
  CONSTRAINT `FK_user_student_student` FOREIGN KEY (`student_id`) REFERENCES `sms_students` (`id`),
  CONSTRAINT `FK_user_student_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
INSERT INTO `sis_user_student` VALUES (6,4),(7,7),(8,8),(9,5),(10,9),(15,15);
