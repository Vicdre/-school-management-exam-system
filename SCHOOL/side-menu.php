<div class="wrapper">
	...
	-->
		<div class="sidebar-wrapper" id="sideLinks" style="background-color:black">
	<div class="sidebar" data-background-color="black" data-active-color="danger">
    <div class="sidebar-wrapper" id="sideLinks" style="background-color:#552277; height:1100px; width:240px; overflow:hidden"> <!-- DARK-PURPLE:59277d    SBIT-PURPLE:#69378d    1: 20124d blue purple 1:#20124d, dark purple 1:#674ea7, dark purple 2:#351c75, dark purple 3:#20124d, light blue:#c4e3f3, light cornflower blue 2:#a4c2f4, dark cornflower blue 3:#1c4587 -->
            <br><div class="logo" style="border:3px outset grey">
                <a href="index.php" class="simple-text">
                   <h2>SIS</h2>School Information System
				   <br>
				   <font size="2" color="grey">Dev. Version 1.01</font>
                </a>
            </div>
            <ul class="nav">
				...
				<!-- exam -->
				<!-- <li id="exMark">
					<a href="kai_exMark.php" class="menu-link">
					<i class="ti-write"></i>
					<p>Exam Marks</p>
					</a>
				</li>
