...
*/		
	...
	*/
	...
	public function listClasses(){		
		$sqlQuery = "SELECT c.id, c.name, s.section, t.teacher, ss.session 
	...
	public function getSessionList(){		
		...
		while( $session = mysqli_fetch_assoc($result)) {
			$sessionHTML .= '<option value="'.$session["session_id"].'">'.$session["session"].'</option>';	
		}
		return $sessionHTML;
	}
	/*****************Teacher methods****************/
